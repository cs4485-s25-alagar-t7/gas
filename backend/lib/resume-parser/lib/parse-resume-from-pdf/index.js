 ...
 */
export var parseResumeFromPdf = function (fileBuffer) { return __awaiter(void 0, void 0, void 0, function () {
    var textItems, lines, sections, resume;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, readPdf(fileBuffer)];
            case 1:
                textItems = _a.sent();
